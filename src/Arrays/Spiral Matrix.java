class Solution {
    public List<Integer> spiralOrder(int[][] matrix) 
    {
        ...
        {
            // row wise left to right -> startingRow print krnih, from startingCol to endingCol
            ...
            endingCol--;
            //row wise right to left -> endingRow print krnih, from endingCol to startingCol
            ...
            //col wise bottom to top -> startingCol print krnah, from endingRow to starttingRow
